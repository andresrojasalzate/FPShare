...
public data class FragmentAdminUFsArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): FragmentAdminUFsArgs {
      bundle.setClassLoader(FragmentAdminUFsArgs::class.java.classLoader)
      ...
      return FragmentAdminUFsArgs(__idModulo, __idCiclo)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): FragmentAdminUFsArgs {
      val __idModulo : String?
