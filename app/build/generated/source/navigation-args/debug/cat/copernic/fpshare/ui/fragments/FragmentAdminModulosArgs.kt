...
public data class FragmentAdminModulosArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): FragmentAdminModulosArgs {
      bundle.setClassLoader(FragmentAdminModulosArgs::class.java.classLoader)
      ...
      return FragmentAdminModulosArgs(__idCiclo)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): FragmentAdminModulosArgs {
      val __idCiclo : String?
