...
public final class ItemTagBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView nombreTag;

  private ItemTagBinding(@NonNull MaterialCardView rootView, @NonNull TextView nombreTag) {
  ...
  public static ItemTagBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.nombreTag;
      TextView nombreTag = ViewBindings.findChildViewById(rootView, id);
      if (nombreTag == null) {
        break missingId;
      }

      return new ItemTagBinding((MaterialCardView) rootView, nombreTag);
    }
