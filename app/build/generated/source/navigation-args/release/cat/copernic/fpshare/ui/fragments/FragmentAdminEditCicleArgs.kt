...
public data class FragmentAdminEditCicleArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): FragmentAdminEditCicleArgs {
      bundle.setClassLoader(FragmentAdminEditCicleArgs::class.java.classLoader)
      ...
      return FragmentAdminEditCicleArgs(__idCiclo)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        FragmentAdminEditCicleArgs {
      val __idCiclo : String?
